...
export default function Navbar({ theme: _theme = 'dark' }: NavbarProps) {
  ...
  return (
    <>
      ...
      {/* Auth Modal - belongs inside Navbar because authModalOpen state is declared in Navbar */}
    ...
    if (test === 'done' && result) {
      if (result.status === 'connected') {
        return (
          <span
            ...
            style={{ color: '#68D391', fontSize: '0.6875rem' }}
          >
      ...
      if (result.status === 'no_key') {
        return (
          <span
            className="inline-flex items-center gap-1"
            style={{ color: 'var(--stone)', fontSize: '0.6875rem' }}
          >
      ...
      return (
        <span
          className="inline-flex items-center gap-1"
          style={{ color: '#FC8181', fontSize: '0.6875rem' }}
          title={result.error}
        >
